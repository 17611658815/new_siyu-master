...
Page({
  ...
  onReachBottom: function () {
    let that = this
    let url = app.globalData.ip +'?type=details_yinpin&id='+that.data.audioId +'&page='+that.data.page;
    that.data.page++
  ...
  getAudio() {
    let that = this;
    let url = app.globalData.ip + '?type=details_yinpin&id=' + that.data.audioId;
